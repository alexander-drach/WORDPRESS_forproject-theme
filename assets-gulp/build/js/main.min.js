...
var _sttickyHeader = require("./modules/sticky-header/stticky-header");
...
},{"./modules/admin-toolbal/admin-toolbar.js":2,"./modules/form-validate/form":4,"./modules/mobile-menu/menu":10,"./modules/modals/init-modals":11,"./modules/slider/slider":13,"./modules/sticky-header/stticky-header":14,"./utils/ios-vh-fix":17}],2:[function(require,module,exports){
"use strict";
...
var stickyHeader = exports.stickyHeader = function stickyHeader() {
  var header = document.querySelector('.header');
